...
// Using sliding window (include r in range)
int minOperations(vector<int>& nums) {
    ...
    while (r < nums.size()) {
        ...
        // Increase r when the next r still make the window valid
        ...
        // Done checking the current valid window, increase l for next window checking
